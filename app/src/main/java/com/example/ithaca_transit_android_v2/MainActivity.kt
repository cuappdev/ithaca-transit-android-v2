...
import com.example.ithaca_transit_android_v2.views.SearchViewDelegate
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val searchViewDelegate = findViewById<SearchViewDelegate>(R.id.searchViewDelegate)
        searchViewDelegate.render()
//        // ======== FOR TESTING ONLY ========
